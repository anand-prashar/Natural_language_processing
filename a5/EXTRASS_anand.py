...
def q7_answer(reasoningData):
    ...
    word_to_vec_dict = gensim.models.KeyedVectors.load_word2vec_format('C:\\Users\\anand\\Downloads\\word2Vec\\file.bin', binary=True)  
    ...
    for groupName, list_of_analogies in reasoningData.iteritems():
        ...
        for analogy in list_of_analogies:
            ...
            returned_vectors =  distsim.show_nearest2(word_to_vec_dict,
