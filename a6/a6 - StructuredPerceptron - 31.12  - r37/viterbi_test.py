...
def run_viterbi_test():
    ...
    num_tests = 1 #1000 # number of sentences to generate
    random.seed(0)
    ...
    for _ in xrange(num_tests):
        N = 2 #random.randint(1, maxN+1)          #   (LENGTH OF 1 CURRENT SENTENCE)
        L = 3 #random.randint(2, maxL+1)          #   (NO OF CLASSES/LABELS )
